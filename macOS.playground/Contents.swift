...
/*:
 ...
 To generate a snapshot from a tileset, you’ll need a [map ID](https://www.mapbox.com/help/define-map-id/). You can either choose a [Mapbox-maintained tileset](https://www.mapbox.com/api-documentation/maps/#maps) or upload your own to [Mapbox Studio](https://www.mapbox.com/studio/tilesets/).
